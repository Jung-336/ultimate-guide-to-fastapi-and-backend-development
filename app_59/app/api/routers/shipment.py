...
from app_59.app.api.dependencies import ShipmentServiceDep, SellerServiceDep
from app_59.app.api.schemas.shipment import ShipmentCreate, ShipmentRead, ShipmentUpdate
